...
// SetOnDblClick registers a callback invoked when the tray icon is double-clicked.
func SetOnDblClick(callback func()) {
	systrayDblClick = callback
}
